# E2E firefox image [![Build Status](https://travis-ci.org/daggerok/e2e.svg?branch=precise-xvfb-jdk8-firefox)](https://travis-ci.org/daggerok/e2e)
...
git add .
git commit -am ...
git push origin precise-xvfb-jdk8-firefox
git tag precise-xvfb-jdk8-firefox-v1
