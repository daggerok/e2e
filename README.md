# E2E chrome image [![Build Status](https://travis-ci.org/daggerok/e2e.svg?branch=bionic-xvfb-jdk8-chrome)](https://travis-ci.org/daggerok/e2e)
...
git tag bionic-xvfb-jdk8-chrome-v3
