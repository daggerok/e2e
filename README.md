# E2E image [![Build Status](https://travis-ci.org/daggerok/e2e.svg?branch=xenial-xvfb-jdk8)](https://travis-ci.org/daggerok/e2e)
...
git add .
git commit -am ...
git push origin xenial-xvfb-jdk8
git tag xenial-xvfb-jdk8-v1
